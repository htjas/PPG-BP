...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[fill=green!30] coordinates {(1,12.95) (2,17.634) (3,9.946) (4,11.271)};
            \addlegendentry{Best (Bi-LSTM WA)\:}
            \addplot[fill=red!30] coordinates {(1,21.309) (2,29.819) (3,15.001) (4,19.107)};
