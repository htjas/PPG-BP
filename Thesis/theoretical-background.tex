...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.5]{images/mimic/mimic_structure}
...
In both databases recorded waveforms typically encompass one or more ECG signals, often feature continuous ABP waveforms and fingertip PPG signals.
