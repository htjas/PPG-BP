...
Techniques such as filtering and feature extraction are commonly utilized in the analysis of PPG pulse waves, often integrated into ML and \ac{DNN} models for BP estimation.
...
In the context of this thesis, various supervised ML techniques are utilized to analyse PPG waveform features and to predict BP values.
